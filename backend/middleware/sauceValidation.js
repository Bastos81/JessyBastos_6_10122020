...
exports.imageValidator = [ // Validation pour le format de l'image
    validate({
        validator: 'matches',
        arguments: /(\.jpg|\.jpeg|\.png)$/i, // Regex pour restreindre le type de symboles pour la description de la sauce
        message: "Vous ne pouvez utiliser que les format jpg, jpeg et png",
    }),
];
